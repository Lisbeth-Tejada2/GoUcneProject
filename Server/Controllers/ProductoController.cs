        ...
        public async Task<IActionResult> Guardar([FromBody] ProductoDTO request)
        {
            ...
            try
            {
                ...
                if (_productoCreado.IdProducto != 0)
                    ...
                    _ResponseDTO = new ResponseDTO<ProductoDTO>() { status = false, msg = "No se pudo crear el ticket" };
            ...
            try
            {
                ...
                if (_productoParaEditar != null)
                {
                    ...
                    if (respuesta)
                        ...
                        _ResponseDTO = new ResponseDTO<bool>() { status = false, msg = "No se pudo editar el ticket" };
                }
                else
                {
                    _ResponseDTO = new ResponseDTO<bool>() { status = false, msg = "No se encontró el ticket buscado :( " };
                }
            ...
            try
            {
                ...
                if (_productoEliminar != null)
                {
                    ...
                    if (respuesta)
                        ...
                        _ResponseDTO = new ResponseDTO<string>() { status = false, msg = "No se pudo eliminar el", value = "" };
                }
